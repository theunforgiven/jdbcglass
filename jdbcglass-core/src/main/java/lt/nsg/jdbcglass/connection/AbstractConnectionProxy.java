...
public abstract class AbstractConnectionProxy extends Wrappable implements Connection {
    ...
    private final LoggingProxyFactory loggingProxyFactory;

    public AbstractConnectionProxy(Connection connection) {
        super(connection);
        this.connection = connection;
        this.loggingProxyFactory = new LoggingProxyFactory(this);
    }

    @Override
    public Statement createStatement() throws SQLException {
        return this.loggingProxyFactory.proxyStatement(this.connection.createStatement());
    }
    ...
    public Statement createStatement(int resultSetType, int resultSetConcurrency) throws SQLException {
        ...
        return this.loggingProxyFactory.proxyStatement(statement);
    }
    ...
    public DatabaseMetaData getMetaData() throws SQLException {
        return this.loggingProxyFactory.proxyDatabaseMetaData(this.connection.getMetaData());
    }

    @Override
    public CallableStatement prepareCall(String sql) throws SQLException {
        CallableStatement statement = this.connection.prepareCall(sql);
        return this.loggingProxyFactory.proxyCallableStatement(statement, sql);
    }
    ...
    public PreparedStatement prepareStatement(String sql) throws SQLException {
        ...
        return this.loggingProxyFactory.proxyPreparedStatement(statement, sql);
    }
